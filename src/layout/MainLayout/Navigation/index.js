        ...
        <>
            ...
            <div onMouseLeave={() => setHover(false)} sx={{ display: 'flex' }}>
                <Slide direction="up" in={isHover} mountOnEnter unmountOnExit>
                    ...
                    >
                        <BottomNavigationAction component={Link} to="/dashboard" label="产品" value="产品" icon={<LocalMall />} />
                        <BottomNavigationAction component={Link} to="/dashboard" label="收藏" value="收藏" icon={<FavoriteIcon />} />
                        <BottomNavigationAction component={Link} to="/dashboard" label="订单" value="订单" icon={<FeaturedPlayList />} />
