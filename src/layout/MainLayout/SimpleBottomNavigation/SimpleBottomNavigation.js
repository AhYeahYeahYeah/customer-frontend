    ...
    return (
        <>
            <div onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
                {isHover ? '' : <Chip sx={{ position: 'absolute', width: '30%', height: '1%', left: '37%', top: '93%' }} />}
            </div>
            ...
            <div onMouseLeave={() => setHover(false)} sx={{ display: 'flex' }}>
                <Slide direction="up" in={isHover} mountOnEnter unmountOnExit>
                    ...
                    >
                        <BottomNavigationAction component={Link} to="/white" label="Recents" value="recents" icon={<RestoreIcon />} />
